...
const CourseDetails = () => {
  ...
  useEffect(() => {
    ...
    const normalizedCourse = {
      coursePrice: findCourse?.coursePrice || 0,
      discount: findCourse?.discount || 0,
      courseDescription: findCourse?.courseDescription || "",
      courseRatings: findCourse?.courseRatings || [],
      enrolledStudents: findCourse?.enrolledStudents || [],
      ...findCourse, // spread last so we preserve any other properties
          ...
          <div className="pt-5 px-4 pb-6">
            ...
            <div className="flex items-center gap-6 pt-4 text-sm text-gray-600">
              <div className="flex items-center gap-1">
                ...
                <p className="font-medium">{calculateRating(courseData) || 0}</p>
              </div>
