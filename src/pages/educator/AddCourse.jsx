...
<div className='flex flex-col gap-1'>
            ...
            <div key={chapterIndex} className='bg-white border rounded-lg mb-4'>
              <div className='flex justify-between items-center p-4 border-b'>
                <div className='flex items-center'>
                  <img className={`mr-2 cursor-pointer transition-all ${chapter.collapsed && "-rotate-90"}`} width={14} alt='' src={ assets.dropdown_icon} />
    ...
    />
        ...
        <button className='bg-black text-white w-max py-2.5 px-8 rounded my-4' type='submit'>
          ADD
        </button>
    </form>
